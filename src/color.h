...
at_color *  at_color_new   (unsigned char r, 
				 unsigned char g,
				 unsigned char b);
at_color *  at_color_parse (const char * string);
at_color *  at_color_copy  (const at_color * original);
bool         at_color_equal (const at_color * c1, const at_color * c2);
void             at_color_set   (at_color * c1, unsigned char r, unsigned char g, unsigned char b);
/* RGB to grayscale */
